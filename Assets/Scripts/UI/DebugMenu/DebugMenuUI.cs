        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    if(GameManager.Instance.interactiveMode == true){
                        GameManager.Instance.interactiveMode = GUILayout.Toggle(GameManager.Instance.interactiveMode, "ON"); 
                    } else{
                        GameManager.Instance.interactiveMode = GUILayout.Toggle(GameManager.Instance.interactiveMode, "OFF");
                    }
                }
                GUILayout.EndHorizontal();
                ...
                // Mute volume(toggle doesn't work though for some reason.)
                GUILayout.BeginHorizontal();
                {
                    GUILayout.Label("Mute volume: ", GUILayout.Width(WINDOW_DIMENSION.x /4.0f));
                    if(SoundManager.Instance.masterMuted == false){
                        SoundManager.Instance.masterMuted = GUILayout.Toggle(SoundManager.Instance.masterMuted, "OFF"); 
                    } else{
                        SoundManager.Instance.masterMuted = GUILayout.Toggle(SoundManager.Instance.masterMuted, "ON");
                    }
                }
                GUILayout.EndHorizontal();
